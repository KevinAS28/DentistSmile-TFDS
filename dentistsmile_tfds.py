...
_BASE_URL = 'http://34.130.7.11:9999'
...
#     self.manual_offline = manual_offline
  ...
  def _split_generators(self, dl_manager: tfds.download.DownloadManager):
    ...
    if OFFLINE:
        path = {'original_all': 'Original All', 'true_mask': 'segmentation_true_mask'}
        ...
        path['original_all'] = os.path.join(path['original_all'], 'Original All')
  ...
  def _generate_examples(self, original_image_dir_path, true_mask_dir_path):
    ...
    for img_mask_dir in os.listdir(true_mask_dir_path):
        ...
        img_mask = os.path.join(true_mask_dir_path, img_mask_dir, f'{img_id+pose}_mask123.png')
